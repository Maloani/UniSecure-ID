...
# Détecter automatiquement la bonne caméra
...
if camera_index == -1:
    print("[ERREUR] Aucune caméra fonctionnelle détectée.")
    exit()
else:
    print(f"[INFO] Caméra détectée à l'index {camera_index}.")

# Initialiser le détecteur de visages et la caméra
